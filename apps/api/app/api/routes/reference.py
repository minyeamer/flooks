...
async def get_api_reference() -> ApiReferenceResponse:
    ...
    dashboard_summary_fields = [
        ...
        ApiFieldReference(name="latestArchivedVersionNumber", type="integer | null", description="가장 최근 archived revision 번호입니다.", required=False),
            ...
            ApiEndpointReference(
                ...
                responses=[
                    ApiResponseReference(
                        ...
                        fields=dashboard_summary_list_fields,
                    ),
                ],
